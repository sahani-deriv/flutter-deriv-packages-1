...
void main() {
  group('buildTextSpanHyperlink', () {
    testWidgets('creates a TextSpan with the correct label and style',
            ...
            child: Builder(
              builder: (BuildContext context) {
                final TextSpan textSpan = buildTextSpanHyperlink(
                    context: context, label: 'Test Label', userAgent: '');
                ...
                expect(
                    textSpan.recognizer, isInstanceOf<TapGestureRecognizer>());
