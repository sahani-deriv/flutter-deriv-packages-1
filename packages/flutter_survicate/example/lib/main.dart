...
class _AppState extends State<App> {
  FlutterSurvicate flutterSurvicate;
            ...
            child: Column(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () => flutterSurvicate.invokeEvent('SURVEY'),
                ),
                RaisedButton(
                  child: const Text('Enter screen SCREEN'),
                  onPressed: () => flutterSurvicate.enterScreen('SCREEN'),
                ),
                RaisedButton(
                  child: const Text('Leave screen SCREEN'),
                  onPressed: () => flutterSurvicate.leaveScreen('SCREEN'),
                ),
                RaisedButton(
                  child: const Text('Set userId = 1 and first name = USER'),
                  onPressed: () => flutterSurvicate.setUserTraits(
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    flutterSurvicate.registerSurveyListeners(
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    flutterSurvicate.unregisterSurveyListeners();
                  },
                ),
                surveyIdDisplayed != null
