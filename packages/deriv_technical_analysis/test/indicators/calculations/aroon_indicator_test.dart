...
void main() {
  group('Aroon Indicator', () {
    ...
    setUpAll(() {
      candles = <MockOHLC>[
        const MockOHLC(0, 168.28, 169.64, 169.87, 167.15),
        const MockOHLC(1, 168.84, 168.71, 169.36, 168.2),
        const MockOHLC(2, 168.88, 167.74, 169.29, 166.41),
        const MockOHLC(3, 168, 166.32, 168.38, 166.18),
        const MockOHLC(4, 166.89, 167.24, 167.7, 166.33),
        const MockOHLC(5, 165.25, 168.05, 168.43, 165),
        const MockOHLC(6, 168.17, 169.92, 170.18, 167.63),
        const MockOHLC(7, 170.42, 171.97, 172.15, 170.06),
        const MockOHLC(8, 172.41, 172.02, 172.92, 171.31),
        const MockOHLC(9, 171.2, 170.72, 172.39, 169.55),
        const MockOHLC(10, 170.91, 172.09, 172.48, 169.57),
        const MockOHLC(11, 171.8, 173.21, 173.31, 170.27),
        const MockOHLC(12, 173.09, 170.95, 173.49, 170.8),
        const MockOHLC(13, 172.41, 173.51, 173.89, 172.2),
        const MockOHLC(14, 173.87, 172.96, 174.17, 175),
        const MockOHLC(15, 173, 173.05, 173.17, 172.06),
        const MockOHLC(16, 172.26, 170.96, 172.28, 170.5),
        const MockOHLC(17, 170.88, 171.64, 172.34, 170.26),
        const MockOHLC(18, 171.85, 170.01, 172.07, 169.34),
        const MockOHLC(19, 170.75, 172.52, 172.56, 170.36),
      ];
    });
