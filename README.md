...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v6.7.19)`. To use the package, add the following to your pubspec.yaml file:
...
deriv_ui:
  git:
    ...
    ref: deriv_ui-v0.0.8+1 #your prefered version
```
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                              | [v6.7.19 ](./packages/deriv_auth/CHANGELOG.md)                     |
...
| [deriv_ui](./packages/deriv_ui)                                           | A package that contains the UI components used by Deriv products.                                                      | [v0.0.8+1](./packages/deriv_ui/CHANGELOG.md)                      |
...
| [deriv_widgetbook](./packages/deriv_widgetbook)                           | Storybook for Deriv UI Widgets and Components                                                                          | [v0.0.2+11](./packages/deriv_widgetbook/CHANGELOG.md)              |
