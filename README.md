...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v4.1.0)`. To use the package, add the following to your pubspec.yaml file:
...
deriv_ui:
  git:
    ...
    ref: deriv_ui-v0.0.5 #your prefered version
```
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                              | [v4.1.0 ](./packages/deriv_auth/CHANGELOG.md)                     |
...
| [deriv_ui](./packages/deriv_ui)                                           | A package that contains the UI components used by Deriv products.                                                      | [v0.0.5](./packages/deriv_ui/CHANGELOG.md)                        |
