...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v7.0.4)`. To use the package, add the following to your pubspec.yaml file:
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                                                             | [v7.0.4 ](./packages/deriv_auth/CHANGELOG.md)                    |
...
| [deriv_localizations](./packages/deriv_localizations)                     | A Package that contains the localization arb(coming from Crowdin) and dart generated files for flutter_deriv_packages.                                | [v1.7.0](./packages/deriv_localizations/CHANGELOG.md)             |
...
| [deriv_mobile_chart_wrapper](./packages/deriv_mobile_chart_wrapper)       | A wrapper package around package _**deriv_chart**_ to implement any functionality specific to mobile and can be wrapped around the main chart package. | [v0.1.6+1](./packages/deriv_mobile_chart_wrapper/CHANGELOG.md)      |
