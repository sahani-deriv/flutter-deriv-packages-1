...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v6.7.20)`. To use the package, add the following to your pubspec.yaml file:
