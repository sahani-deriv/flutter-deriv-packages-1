...
| [update_checker](./packages/update_checker)                               | Check and retrieve update information from the server for the given package.                                           | [v2.0.0](./packages/update_checker/CHANGELOG.md)                  |
