...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v6.7.26)`. To use the package, add the following to your pubspec.yaml file:
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                              | [v6.7.26 ](./packages/deriv_auth/CHANGELOG.md)                     |
