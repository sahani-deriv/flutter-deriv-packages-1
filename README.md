...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v7.0.3)`. To use the package, add the following to your pubspec.yaml file:
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                                                             | [v7.0.3 ](./packages/deriv_auth/CHANGELOG.md)                    |
...
| [deriv_mobile_chart_wrapper](./packages/deriv_mobile_chart_wrapper)       | A wrapper package around package _**deriv_chart**_ to implement any functionality specific to mobile and can be wrapped around the main chart package. | [v0.1.6](./packages/deriv_mobile_chart_wrapper/CHANGELOG.md)      |
